...
$html .= $this->msg('parentheses')->params(Message::listParam([
    Message::rawParam($firstLink),
    Message::rawParam($lastLink),
], ListType::PIPE))->escaped() . ' ';

// Same expression, single-line array
$html .= $this->msg('parentheses')->params(Message::listParam([Message::rawParam($firstLink), Message::rawParam($lastLink)], ListType::PIPE))->escaped() . ' ';
